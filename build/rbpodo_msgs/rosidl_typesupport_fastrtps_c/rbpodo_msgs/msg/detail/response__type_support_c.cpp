...
#include "rbpodo_msgs/msg/detail/response__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // category, error, msg
#include "rosidl_runtime_c/string_functions.h"  // category, error, msg

// forward declare type support functions


using _Response__ros_msg_type = rbpodo_msgs__msg__Response;
...
size_t get_serialized_size_rbpodo_msgs__msg__Response(
  const void * untyped_ros_message,
...
static uint32_t _Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rbpodo_msgs__msg__Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rbpodo_msgs
size_t max_serialized_size_rbpodo_msgs__msg__Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rbpodo_msgs__msg__Response;
    is_plain =
      (
...
static size_t _Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rbpodo_msgs__msg__Response(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rbpodo_msgs, msg, Response)() {

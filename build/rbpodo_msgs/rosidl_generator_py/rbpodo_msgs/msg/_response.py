...
class Metaclass_Response(type):
    ...
    @property
    def ACK(self):
        """Message constant 'ACK'."""
        return Metaclass_Response.__constants['ACK']

    @property
    def INFO(self):
        """Message constant 'INFO'."""
        return Metaclass_Response.__constants['INFO']

    @property
    def WARN(self):
        """Message constant 'WARN'."""
        return Metaclass_Response.__constants['WARN']

    @property
    def ERROR(self):
        """Message constant 'ERROR'."""
        return Metaclass_Response.__constants['ERROR']

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_Response.__constants['UNKNOWN']

...
static const _MoveJb2Point_type_support_symbol_names_t _MoveJb2Point_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rbpodo_msgs, msg, MoveJb2Point)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rbpodo_msgs, msg, MoveJb2Point)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rbpodo_msgs, msg, MoveJb2Point)() {
  return &::rbpodo_msgs::msg::rosidl_typesupport_c::MoveJb2Point_message_type_support_handle;
}

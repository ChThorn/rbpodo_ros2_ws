...
static const _TaskPause_Request_type_support_symbol_names_t _TaskPause_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rbpodo_msgs, srv, TaskPause_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rbpodo_msgs, srv, TaskPause_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rbpodo_msgs, srv, TaskPause_Request)() {
  return &::rbpodo_msgs::srv::rosidl_typesupport_c::TaskPause_Request_message_type_support_handle;
}
...
static const _TaskPause_Response_type_support_symbol_names_t _TaskPause_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rbpodo_msgs, srv, TaskPause_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rbpodo_msgs, srv, TaskPause_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rbpodo_msgs, srv, TaskPause_Response)() {
  return &::rbpodo_msgs::srv::rosidl_typesupport_c::TaskPause_Response_message_type_support_handle;
}
...
static const _TaskPause_type_support_symbol_names_t _TaskPause_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rbpodo_msgs, srv, TaskPause)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rbpodo_msgs, srv, TaskPause)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rbpodo_msgs, srv, TaskPause)() {
  return &::rbpodo_msgs::srv::rosidl_typesupport_c::TaskPause_service_type_support_handle;
}

...
#include "rbpodo_msgs/msg/detail/response__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rbpodo_msgs::msg::Response & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rbpodo_msgs::msg::Response & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rbpodo_msgs::msg::Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rbpodo_msgs::msg::Response *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rbpodo_msgs::msg::Response *>(
    untyped_ros_message);
...
{
  return &rbpodo_msgs::msg::typesupport_fastrtps_cpp::_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rbpodo_msgs, msg, Response)() {
  return &rbpodo_msgs::msg::typesupport_fastrtps_cpp::_Response__handle;
}
